...
MulierAlto = {
  \relative c' {
    ...
    g8. g16 g4 r2
    R1*4 %22
    \mvTr ges4.\fE^\tuttiE ges8 f2
    es es8 f f4
    e f8 f f4( e) %25
    f r r2
    R1
    r2 r4 \mvTr f8\pE^\solo f
    f b, f' b16 as g([ f)] g8 r es
    es[ f16 g] as[ b g as] f8[ g16 as] b[ c as b] %30
    g8[ f16 es] f4\trill es r
